          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            <div className="px-5 py-4 bg-gradient-to-r from-[#cc0000] to-red-700 text-white border-b border-red-600 flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <h2 className="font-bold text-base uppercase tracking-wide text-white">Story Arc Tracker</h2>
              </div>
            ...
            <div className="p-5">
              <ul className="space-y-4 border-l-3 border-red-200 ml-2 pl-4">
                <li className="relative">
                  ...
                  <div className="text-xs font-bold uppercase tracking-wider text-black mb-1">Now</div>
                  <p className="text-sm text-black leading-relaxed">{article.title.substring(0, 50)}...</p>
                </li>
                <li className="relative">
                  <span className="absolute -left-5 top-1.5 h-3 w-3 rounded-full bg-gray-300 border-2 border-white shadow-md"></span>
                  <div className="text-xs font-bold uppercase tracking-wider text-black mb-1">Predicted</div>
                  <p className="text-sm text-black leading-relaxed">Regulatory impact assessment incoming.</p>
                </li>
              </ul>
            </div>
          </div>
